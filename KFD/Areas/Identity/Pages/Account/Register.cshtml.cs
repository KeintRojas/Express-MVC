...
namespace KFD.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            if (!_roleManager.RoleExistsAsync(Utilities.StaticValues.Role_Admin).GetAwaiter().GetResult()) { 
                _roleManager.CreateAsync(new IdentityRole(Utilities.StaticValues.Role_Admin))
                    .GetAwaiter().GetResult();
            }

            if (!_roleManager.RoleExistsAsync(Utilities.StaticValues.Role_Customer).GetAwaiter().GetResult())
            {
                _roleManager.CreateAsync(new IdentityRole(Utilities.StaticValues.Role_Customer))
                    .GetAwaiter().GetResult();
            }

            if (!_roleManager.RoleExistsAsync(Utilities.StaticValues.Role_Chef).GetAwaiter().GetResult())
            {
                _roleManager.CreateAsync(new IdentityRole(Utilities.StaticValues.Role_Chef))
                    .GetAwaiter().GetResult();
            }
